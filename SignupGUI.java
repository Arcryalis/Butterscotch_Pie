...
public class SignupGUI extends GUI {
	...
	/**
	 * Implementation of SignupGUI
	 */
	protected void makeGUI() {
		m_frmSignUp = new JFrame();
		m_frmSignUp.setIconImage(Toolkit.getDefaultToolkit().getImage("/Skypertawe Icon.png"));
		...
		/*
		 * creates an account if username is not already taken
		 */
		...
		m_btnCreateAccount.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (uname.equals("") || m_pwrdfld.getPassword().length == 0 || fname.equals("") || lname.equals("")
						|| phonenum.equals("")) {
		...
		/*
		 * Cancelbutton returns the user to the LoginGUI
		 */
		...
		groupLayout.setHorizontalGroup(groupLayout
				.createParallelGroup(Alignment.LEADING).addGroup(groupLayout.createSequentialGroup().addGap(31)
										...
										.addGroup(
												groupLayout.createParallelGroup(Alignment.LEADING)
														...
														.addComponent(lblFirstname).addComponent(
																lblLastname)
														.addComponent(lblDateOfBirth).addComponent(lblCity))
										.addGap(38)
										.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
												.addGroup(groupLayout.createSequentialGroup()
														...
														.addPreferredGap(ComponentPlacement.RELATED,
																46, Short.MAX_VALUE)
														.addComponent(m_btnCancel).addGap(35))
												.addGroup(groupLayout.createSequentialGroup()
														.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
																.addComponent(m_pwrdfld, Alignment.LEADING,
																		GroupLayout.DEFAULT_SIZE, 253, Short.MAX_VALUE)
																.addComponent(m_usernametxtfld, Alignment.LEADING,
																		GroupLayout.DEFAULT_SIZE, 253, Short.MAX_VALUE)
																.addComponent(m_fnametxtfld, Alignment.LEADING,
																		GroupLayout.DEFAULT_SIZE, 253, Short.MAX_VALUE)
																.addComponent(m_lnametxtfld, Alignment.LEADING,
																		GroupLayout.DEFAULT_SIZE, 253, Short.MAX_VALUE)
																.addComponent(m_phonenumtxtfld,
																		GroupLayout.DEFAULT_SIZE, 253, Short.MAX_VALUE)
																.addComponent(m_dobtxtfld, Alignment.LEADING,
																		GroupLayout.DEFAULT_SIZE, 253, Short.MAX_VALUE)
																.addComponent(m_citytxtfld, Alignment.LEADING,
																		GroupLayout.DEFAULT_SIZE, 253, Short.MAX_VALUE))
														.addPreferredGap(ComponentPlacement.RELATED))))
								.addComponent(lblUkPhoneNumber))
						.addGap(51))
				.addGroup(Alignment.TRAILING,
						groupLayout.createSequentialGroup().addContainerGap(110, Short.MAX_VALUE)
								.addComponent(m_lblLogo, GroupLayout.PREFERRED_SIZE, 264, GroupLayout.PREFERRED_SIZE)
								.addGap(60)));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(Alignment.LEADING).addGroup(groupLayout
				.createSequentialGroup().addContainerGap().addComponent(m_lblLogo).addGap(51)
				.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(m_usernametxtfld, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addComponent(lblUsername))
				.addGap(18)
				.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(lblPassword).addComponent(
						m_pwrdfld, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGap(18)
				.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(lblFirstname).addComponent(
						m_fnametxtfld, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
						GroupLayout.PREFERRED_SIZE))
				.addGap(25)
				.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(lblLastname)
						.addComponent(m_lnametxtfld, GroupLayout.PREFERRED_SIZE, 17, GroupLayout.PREFERRED_SIZE))
				.addGap(34)
				.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(lblUkPhoneNumber)
						.addComponent(m_phonenumtxtfld, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE))
				.addGap(28)
				.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING).addComponent(lblDateOfBirth).addComponent(
						m_dobtxtfld, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGap(18)
				.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING).addComponent(lblCity).addComponent(
						m_citytxtfld, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGap(18).addGroup(groupLayout.createParallelGroup(Alignment.BASELINE).addComponent(m_btnCancel)
						.addComponent(m_btnCreateAccount))
				.addGap(34)));
